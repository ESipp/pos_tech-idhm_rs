...
df_idhm_esp = pd.read_csv('IDHM_RS.csv')

#Titulo de Página
st.title('IDHM-RS: Índice de Desenvolvimento Humano do Estado do Rio Grande do Sul')
...
with tab1:
    ...
    fig5.update_layout(title_text="IDHM Estado do Rio Grande do Sul")
